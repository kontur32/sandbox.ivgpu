  ...
  let $data :=  
    <table>
      <row id = "fields">
        ...
        <cell id = "ФИО_руководителя_полное">{
          string-join(($руководитель/Фамилия, $руководитель/Имя, $руководитель/Отчество ), ' ')
        }</cell>
        ...
        <cell id = "Дата_подписания">{ $данныеСтудента/cell[ @label = "Дата_подписания" ]/text() }</cell>
      </row>
    </table>
  return
    $data
