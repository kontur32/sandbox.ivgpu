...
function ivgpu:view(){
  <div>
    ...
    <ul>
      ...
      <li>
        <a href = '/sandbox/ivgpu/subjects.Departments.List?mode=other&amp;id=29'>Список дисциплин по кафедре</a>
      </li>
      <li>
        <a href = '/sandbox/ivgpu/plans.datafile.build'>Обновить базу (запустить бота)</a>
      </li>
    </ul>
