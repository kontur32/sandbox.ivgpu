  ...
  let $data := 
    <table>
      <row  id = 'fields'>
        ...
        <cell id="вопросыПромежуточнойАттестации">{ if( $автор/row[ @id = "tables" ]/cell/table[ @id = 'Вопросы промежуточной аттестации']//cell/text() != "" )then()else( 'В соответствии с ФОС.' ) }</cell>
